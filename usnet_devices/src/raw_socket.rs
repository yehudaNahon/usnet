...
pub struct RawSocket {
    lower: Arc<RwLock<raw_socket_sys::RawSocketDesc>>,
    mtu: usize,
...
impl RawSocket {
    ...
    pub fn new(name: &str, reduce_mtu_by: Option<usize>) -> io::Result<RawSocket> {
        let mut lower = raw_socket_sys::RawSocketDesc::new(name)?;
